            ...
            <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                <div class="product_detail_category m-t-30 p-t-15 p-b-15 text-center">
                    <ul style="display: inline;">
                        ...
                        <li style="display: inline; padding-left: 40px"> <button>Backpack</button></li>
                        <li style="display: inline; padding-left: 40px"> <button>Cross bag</button></li>
                        <li style="display: inline; padding-left: 40px"> <button>clutches</button></li>
                        <li style="display: inline; padding-left: 40px"> <button>Tote bag</button></li>
                        <li style="display: inline; padding-left: 40px"> <button>Suitcase</button></li>
                    </ul>
                </div>
                ...
                <div class="row">
                    ...
                    $sql2 = mq("select * from product where pgroup1='BAG'");
                    ...
                    $sql = mq("select * from product where pgroup1='BAG' order by idx desc limit $start_num,$list;");
