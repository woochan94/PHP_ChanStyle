            ...
            <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                <div class="product_detail_category m-t-30 p-t-15 p-b-15 text-center">
                    <ul style="display: inline;">
                        ...
                        <li style="display: inline; padding-left: 40px"> <button>Coat</button></li>
                        <li style="display: inline; padding-left: 40px"> <button>Padding</button></li>
                        <li style="display: inline; padding-left: 40px"> <button>Jacket</button></li>
                ...
                <div class="row">
                    ...
                    $sql2 = mq("select * from product where pgroup1='OUTER'");
                    ...
                    $sql = mq("select * from product where pgroup1='OUTER' order by idx desc limit $start_num,$list;");
